    ...
    <>
      ...
      >
        ...
        <img 
          src={textLogo} 
          alt="Branca" 
          className={`absolute bottom-4 left-4 md:bottom-8 md:left-8 h-14 sm:h-16 md:h-20 lg:h-24 xl:h-30 w-auto max-w-[60vw] transition-opacity duration-1000 ${logoVisible ? 'opacity-100' : 'opacity-0'}`}
        />
      </div>
    </>
  );
